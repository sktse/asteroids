...
public class PausedDialogFragment extends DialogFragment {

    public interface OnDialogDismissedListener {
        public void onDismiss(int event);
    }

    public static final int RESET_EVENT = 0;
    public static final int QUIT_EVENT = 1;
    public static final int RESUME_EVENT = 2;

    private OnDialogDismissedListener _listener;

    public PausedDialogFragment() {
        super();
        _listener = null;
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        resetButton.setTypeface(basicTypeface);
        resetButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (_listener != null) {
                    _listener.onDismiss(RESET_EVENT);
                }
            }
        });
